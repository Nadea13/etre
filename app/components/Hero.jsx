        ...
        <section className='relative pt-16 min-h-[90vh] flex flex-col justify-end pb-12 overflow-hidden border-b border-gray-200'>
            ...
            <div className='relative z-10 px-6 max-w-7xl mx-auto w-full flex flex-col gap-6'>
                <div className='flex flex-col gap-2'>
                    ...
                    <p className='text-gray-600 text-sm md:text-lg font-medium tracking-wide max-w-sm uppercase'>
                        Experience the fusion of elite performance and street aesthetics.
                    </p>
                </div>
                <div className='pt-4'>
                    <button className='group relative overflow-hidden bg-[#C4002E] text-white px-10 py-5 w-full md:w-auto min-w-[240px] text-center font-bold tracking-widest text-sm uppercase transition-all active:scale-95 hover:bg-[#914a31] rounded-none shadow-xl'>
