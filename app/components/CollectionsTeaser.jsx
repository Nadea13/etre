    ...
    return (
        <section className='py-20 px-6 max-w-7xl mx-auto w-full'>
            <div className='flex items-center justify-between mb-12'>
                ...
                <a className='text-xs text-[#C4002E] font-bold uppercase tracking-widest border-b-2 border-[#C4002E] pb-1 hover:text-black hover:border-black transition-all' href='#'>View All Gear</a>
            </div>
