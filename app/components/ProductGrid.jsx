...
const productsData = [
    {
        ...
        images: [
            "/uploads/486A8923.jpg",
            "/uploads/486A9848.jpg",
            "/uploads/486A9841.jpg",
    ...
    },
    {
        ...
        collection: "First Collection",
        badge: "New Arrival",
        mainImage: "/uploads/486A0313.jpg",
        images: [
                ...
                {productsData.map((product) => (
                    ...
                    >
                        <div className='relative w-full aspect-[4/5] bg-gray-100 overflow-hidden'>
                            ...
                            {product.badge && (
                                <div className='absolute top-3 left-3 bg-black text-white px-2 py-1 text-[9px] font-bold tracking-tighter'>
                                    {product.badge}
                                </div>
                            )}
                        </div>
                        <div className='p-4 flex flex-col justify-between gap-3 border-t border-gray-200'>
                            <div>
                                ...
                                <p className='text-[10px] md:text-xs text-gray-500 mt-1'>{product.info}</p>
                            </div>
                            <div className='flex items-center justify-between mt-1'>
                                ...
                                <button
                                    onClick={(e) => {
                                        e.stopPropagation();
                                        // Specific cart logic could go here
                                    }}
                                    className='bg-[#C4002E] text-white h-8 w-8 flex items-center justify-center hover:bg-black transition-all'
                                >
